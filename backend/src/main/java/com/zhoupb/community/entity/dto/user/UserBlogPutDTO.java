...
@Setter
@EnableValidator
public class UserBlogPutDTO implements BaseDTO<BlogVo> {
	...
	@Override
	public BlogVo toVo() {
		return new BlogVo(id, title, tags, contentMarkdown, contentHtml, null, null, null, null, null, null, null, null, userId);
	}
