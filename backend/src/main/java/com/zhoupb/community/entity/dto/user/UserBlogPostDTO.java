...
@Setter
@EnableValidator
public class UserBlogPostDTO implements BaseDTO<BlogVo> {
	...
	@Override
	public BlogVo toVo() {
		return new BlogVo(null, title, tags, contentMarkdown, contentHtml, null, null, null, null, null, null, null, null, userId);
	}
