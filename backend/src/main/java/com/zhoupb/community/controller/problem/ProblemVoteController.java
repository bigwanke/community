...
import com.zhoupb.community.entity.dto.problem.ProblemVotePostDTO;
import com.zhoupb.community.service.ProblemVoteService;
import com.zhoupb.validation.Validation;

@RestController
@RequestMapping("problem/vote/")
public class ProblemVoteController {
	...
	@LoginRequired
	@Validation
	public JSONResponse post(HttpServletRequest request, @RequestBody ProblemVotePostDTO vote) {
